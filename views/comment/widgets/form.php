<?php
    ...
    $placeholder = ($isNestedComment)
        ? Yii::t('custom', 'Написать комментарий')
        : Yii::t('custom', 'Написать комментарий');
...
<div id="comment_create_form_<?= $id ?>" class="comment-create comment_create" data-ui-widget="comment.Form" style="<?php if ($isHidden): ?>display:none<?php endif; ?>">

    <div class="comment-create-image">
        <?= Image::widget([
            'user' => $userModel,
            'link'  => false,
            'width' => 40,
